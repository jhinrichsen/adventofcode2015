...
image:https://gitlab.com/jhinrichsen/adventofcode2015/badges/master/pipeline.svg[link="https://gitlab.com/jhinrichsen/adventofcode2015/-/commits/master",title="pipeline status"]
